...
server.tool(
  "create_memorial",
  "Create a new digital memorial profile for a loved one. Returns a profile ID used for adding memories and chatting.",
  {
...
server.tool(
  "add_memory",
  "Add a text memory to an existing memorial profile. Share stories, anecdotes, and personal recollections.",
  {
...
server.tool(
  "chat_with_memorial",
  "Have a conversation with the AI memorial. The AI draws on all contributed memories to respond in a way that reflects the memorialized person's personality and life.",
  {
...
server.tool(
  "get_memorial",
  "Get details about a memorial profile including name, bio, memory count, and analytics.",
  {
    profileId: z.string().describe("The memorial profile ID"),
  },
  async ({ profileId }) => {
